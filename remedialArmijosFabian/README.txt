...
a persistence unit "LogicaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Logica\pom.xml":
...
artifact ("Logica.war") is already built. You can build
